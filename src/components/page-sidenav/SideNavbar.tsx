...
const NavbarRoot = styled(BazarCard)<{ isfixed: boolean; sidebarstyle: "style1" | "style2" }>(
...
const StyledList = styled(FlexBox)(({ theme }) => ({
  ...
  "&:hover": {
    "& .listCircle": { background: theme.palette.primary[300] },
  },
}));

const BorderBox = styled(FlexBetween)<{ linestyle: "dash" | "solid" }>(({ theme, linestyle }) => ({
  marginTop: 5,
  marginBottom: 15,
  "& span": { width: "100%" },
  ...(linestyle === "dash" && {
