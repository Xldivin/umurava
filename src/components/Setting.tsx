...
const BodyWrapper = styled(Box)<{ showBody: number }>(({ theme, showBody }) => ({
  overflow: "auto",
  borderRadius: "4px",
...
const demos = [
  { id: 1, path: "/superstore-shop", img: "/assets/images/landing/page-1.png" },
  { id: 2, path: "/grocery2", img: "/assets/images/landing/page-2.png" },
  { id: 3, path: "/fashion-shop", img: "/assets/images/landing/page-3.png" },
  { id: 4, path: "/gadget-shop", img: "/assets/images/landing/page-4.png" },
  { id: 5, path: "/furniture-shop", img: "/assets/images/landing/furniture.png" },
  { id: 6, path: "/gift-shop", img: "/assets/images/landing/gift-shop.png" },
  { id: 7, path: "/grocery1", img: "/assets/images/landing/grocery1.png" },
  { id: 8, path: "/grocery3", img: "/assets/images/landing/grocery3.png" },
  { id: 9, path: "/healthbeauty-shop", img: "/assets/images/landing/healthbeauty.png" },
];
