...
const SaleLayout: FC<SaleLayoutProps> = ({ children, title, type }) => (
  <Fragment>
    <Head>
      <title>{title}</title>
      <meta charSet="utf-8" />
