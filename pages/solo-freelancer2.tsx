...
function client_form() {
  ...
  return (
    ...
    <Box sx={{zIndex: 'modal', background: '#FFFFFF', width:{sm:768,md:1600},height:{sm:"240vh",md:1672},overflowX:{xs:"hidden",sm:"hidden",lg:"hidden"},overflowY:{xs:"hidden",sm:"hidden",lg:"hidden"}}}>
        <Header_W />
        <Box_Header />
        <Body1 />
        <Footer />
